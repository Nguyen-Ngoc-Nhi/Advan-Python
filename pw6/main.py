...
class StudentMarkManagement:
    ...
    def write_to_file(self, file_name, data):
        ...
        with open(file_name, 'wb') as file:
            pickle.dump(data, file)  # Serialize and write data using pickle
...
def main():
    ...
    if os.path.exists("students.dat"):
        ...
        system.students, system.courses, system.marks, system.ects = pickle.loads(decompressed_data)  # Deserialize data
    else:
        ...
        system.write_to_file("students.txt", system.students)
        system.write_to_file("courses.txt", system.courses)
        system.write_to_file("marks.txt", system.marks)
        system.write_to_file("ects.txt", system.ects)
        
        # Compress data before closing the program
        system.compress_data("students.dat")
