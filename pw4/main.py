...
from output import display_summary
...
def main(stdscr):
    ...
    summary_data = system.prepare_summary_data()
    display_summary(stdscr, system.prepare_summary_header(), summary_data)

    sorted_students = system.sort_students_by_gpa()
    sorted_students_data = system.prepare_sorted_students_data(sorted_students)

    display_summary(stdscr, "Sorted Students by GPA:", sorted_students_data)
